...
class App:
    ...
    def _calibrated_screen_x(hand_x, monitors, zone_centers):
        ...
        ball visually reaches a monitor exactly when the hand position
    ...
    def _move_paper_ball(self, info):
        ...
        # make the ball twitch -- moves a fraction of the remaining
        # distance to the target each frame rather than snapping to it.
        ...
        self._drag_last_ball_rect = (sx - BALL_SIZE / 2, sy - BALL_SIZE / 2, sx + BALL_SIZE / 2, sy + BALL_SIZE / 2)
